...
const SearchNewsPage = () => {
    ...
    return (
        ...
        <main>
                <h1>search News</h1>
                <Alert>
          This Page uses <strong>client-side data fetching</strong> to show fetch data for every search. Requests are handled by our backend via <strong>API routess.</strong>
        </Alert>
